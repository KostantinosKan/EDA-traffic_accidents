...
def create_usa_map(df=accidents_df):
    ...
    # Load the US shape file from https://www2.census.gov/geo/tiger/GENZ2018/shp/cb_2018_us_state_500k.zip
    shapefile_state = "data/us_states/cb_2018_us_state_500k.shp"
    gdf_state = gpd.read_file(shapefile_state)

    # Create the final dataframe by merging the gdf_state with the pop_df dataframes
    final_df = gdf_state.merge(right=pop_df, left_on="STUSPS", right_on="State", how="inner")
